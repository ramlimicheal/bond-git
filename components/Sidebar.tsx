            ...
            {salesOpen && (
              <div className="pl-10 space-y-1 mt-1">
                ...
                <button
                  type="button"
                  onClick={() => handleNav(Page.DASHBOARD)}
                  className={`block w-full text-left px-3 py-2 text-sm font-medium rounded-md transition-colors cursor-pointer ${currentPage === Page.DASHBOARD || currentPage === Page.INVOICE_DETAILS
